    ...
    >
          ...
          >
            ...
            <form className="space-y-4 mt-12">
              ...
              <div className="flex items-center bg-[#FFEAD2] text-black px-3 py-3 rounded-md border border-[#8B4A3D] border-b-4 border-b-[#3E0708] hover:shadow-[0_2px_0_0_#3E0708] transition space-x-2">
                ...
                />
                 <span
        className="absolute left-[275px] cursor-pointer text-gray-500"
      ...
      >
              ...
              <div className="flex justify-end text-xs">
                  <Link
    to="/ForgetPassword"
    className="font-medium text-white hover:text-red-700 transition duration-300 underline"
  >
    Forget Password?
  </Link>
              </div>
              ...
              <motion.div whileHover={{ scale: 1.03 }}>
                <div className="flex justify-center">
                  <button
                    type="submit"
                    className="w-[170px] h-[50px] py-2 rounded-[50px] bg-[#731914] text-white text-md font-semibold hover:bg-[#6e1818] transition"
                  >
                    Login
                  </button>
                </div>
